...
def sample_molecule_given_graph(graph_path: str,
    ...
    """Generate new molecules conditioned on a given pocket pdb file"""
...
def test_sample_molecule_given_graph(pdb_path: str = "data_extracted_graphs/1a1e.pt"):
    model = load_checkpoint("/cluster/work/math/pbaertschi/molecular-diffusion/training_runs/RM_COM_DiffSBDD_config_1029_091048_datasets/dataset_pdbbind_train/checkpoint_epoch_100.pt")
    samples = sample_molecule_given_graph(pdb_path, model)
    print(samples)
...
if __name__ == '__main__':
    ...
    mol = test_sample_molecule_given_graph()
